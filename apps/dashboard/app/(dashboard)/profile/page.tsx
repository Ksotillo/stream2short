...
export default async function ProfilePage() {
  ...
  // On desktop, redirect to settings (profile is mobile-only)
  // The check happens client-side via CSS, but this gives a fallback route
      ...
      <div className="hidden lg:block">
        <script
          dangerouslySetInnerHTML={{
            __html: `window.location.href = '/settings';`,
          }}
        />
